...
(function () {
    function b(a, b) { var g = Array.from(a.querySelectorAll(b)); a.matches && a.matches(b) && g.splice(0, 0, a); return g } function f(a) { a = a.getBoundingClientRect(); return { top: a.top + document.body.scrollTop, left: a.left + document.body.scrollLeft } } function c(a) { return parseFloat(getComputedStyle(a, null).height.replace("px", "")) } function q(a) { return parseFloat(getComputedStyle(a, null).width.replace("px", "")) } function l(a) { "loading" != document.readyState ? a() : document.addEventListener("DOMContentLoaded", a) } function p(a) {
        (function d() {
            0 >
            (a.style.opacity -= .1) ? a.style.display = "none" : requestAnimationFrame(d)
        })()
    } function t(a) { a.style.display = "block"; (function d() { var b = parseFloat(a.style.opacity); 1 < (b += .1) || (a.style.opacity = b, requestAnimationFrame(d)) })() } function w(a) {
        var b = [], d = { blackberry: "BlackBerry", android: "Android", windows: "IEMobile", opera: "Opera Mini", ios: "iPhone|iPad|iPod" }; a = "undefined" == typeof a ? "*" : a.toLowerCase(); "*" === a ? b = Object.values(d) : a in d && b.push(d[a]); return !(!b.length || !navigator.userAgent.match(new RegExp(b.join("|"),
            "i")))
    } function E(a) { var b = a.querySelector(".carousel-item"); a = a.querySelector(".carousel-indicators > li"); b.classList.add("active"); a && a.classList.add("active") } function A(a) {
        var b = a.getAttribute("id") + "-carousel", d = a.getAttribute("data-bs-version") && a.getAttribute("data-bs-version").startsWith("5"); a.querySelectorAll(".carousel").forEach(function (a) { a.setAttribute("id", b) }); a.querySelector(".carousel-controls") && a.querySelectorAll(".carousel-controls").forEach(function (a) {
            a.querySelectorAll("a").forEach(function (a) {
                a.setAttribute("href",
                    "#" + b); d ? a.setAttribute("data-bs-target", "#" + b) : a.setAttribute("data-target", "#" + b)
            })
        }); a.querySelectorAll(".carousel-indicators > li").forEach(function (a) { d ? a.setAttribute("data-bs-target", "#" + b) : a.setAttribute("data-target", "#" + b) }); E(a)
    } function F(a) {
        var b = a.querySelectorAll(".carousel-item").length, d = a.querySelector(".carousel-inner").getAttribute("data-visible"); b < d && (d = b); a.querySelectorAll(".carousel-inner").forEach(function (a) { a.setAttribute("class", "carousel-inner slides" + d) }); a.querySelectorAll(".clonedCol").forEach(function (a) { a.remove() });
        a.querySelectorAll(".carousel-item .col-md-12").forEach(function (a) { 2 > d ? a.setAttribute("class", "col-md-12") : "5" == d ? a.setAttribute("class", "col-md-12 col-lg-15") : a.setAttribute("class", "col-md-12 col-lg-" + 12 / d) }); a.querySelectorAll(".carousel-item .row").forEach(function (a) { a.setAttribute("style", "-webkit-flex-grow: 1; flex-grow: 1; margin: 0;") }); a.querySelectorAll(".carousel-item").forEach(function (a) {
            for (var b = a, g = 1; g < d; g++) {
                (b = b.nextElementSibling) || (b = a.parentNode.children[0] === a ? a.nextElementSibling :
                    a.parentNode.children[0]); var k; if (k = b) { var c = 0; do c++; while (k = k.previousElementSibling); k = c } else k = -1; c = b.querySelector(".col-md-12").cloneNode(!0); c.classList.add("cloneditem-" + g); c.classList.add("clonedCol"); c.setAttribute("data-cloned-index", k); a.children[0].appendChild(c)
            }
        })
    } function G(a) {
        var b = "", d = a.querySelector("svg linearGradient"); if (d) {
            b = []; d = Array.from(d.children); for (var k = 0; k < d.length; k++)b.push('"' + d[k].getAttribute("stop-color") + '"'); b = '"lineargradient": [' + b + "],"; Array.from(a.querySelectorAll("svg")).some(function (a) { return a.classList.contains("svg-gradient") }) ||
                a.querySelectorAll("svg").forEach(function (a) { a.classList.add("svg-gradient") })
        } return b
    } function y(a, b, d) {
        var g = a.closest(".card"), h = g.parentElement.classList; g.getAttribute("style") || g.setAttribute("style", "-webkit-flex-basis: auto; flex-basis: auto;"); h.contains("row") && (h.remove("row"), h.add("media-container-row")); a.querySelectorAll(".svg-gradient > *").forEach(function (a) { a.setAttribute("id", b) }); g = a.cloneNode(!0); Array.from(a.children).forEach(function (a) { if ("SVG" !== a.tagName) return a.remove() });
        a.setAttribute("data-pie", "{ " + G(a.closest("section")) + ' "percent": ' + d + ', "size": 150, "colorCircle": "#f1f1f1", "stroke": 5, "colorSlice": "url(#' + b + ')", "fontSize": "1.3rem", "number": false }'); Array.from(g.children).forEach(function (b) { switch (!0) { case b.matches("p"): b.innerText = d + "%"; a.appendChild(b); break; case b.matches("svg"): break; default: a.appendChild(b) } })
    } function C(a) { var b = a.closest("section").getAttribute("id") + "-svg-gradient", d = +a.getAttribute("data-goal"); y(a, b, d) } function H(a, b) {
        if (a.classList.contains("circle-progress-section") &&
            b.includes("progress") && "progressCount" != b) if (b.includes("Color")) a.querySelectorAll(".pie_progress").forEach(function (b) { var d = a.getAttribute("id") + "-svg-gradient", h = +b.getAttribute("data-goal"); y(b, d, h) }); else { var d = a.getAttribute("id") + "-svg-gradient"; b = a.querySelector("." + b); var g = +b.getAttribute("data-goal"); y(b, d, g) }
    } var e, m, u = "function" == typeof jQuery; u && (e = jQuery); e ? m = e("html").hasClass("is-builder") : m = document.querySelector("html").classList.contains("is-builder"); Element.prototype.parents =
        function (a) { for (var b = [], d = this, c = void 0 !== a; null !== (d = d.parentElement);)d.nodeType === Node.ELEMENT_NODE && (c && !d.matches(a) || b.push(d)); return b }; Element.prototype.footerReveal = function () {
            function a() { !d && this.offsetHeight <= window.outerHeight ? (this.style.zIndex = "-999", this.style.position = "fixed", this.style.bottom = "0", this.style.width = b.offsetWidth, b.style.marginBottom = this.offsetHeight) : (this.style.zIndex = "", this.style.position = "", this.style.bottom = "", this.style.width = "", b.style.marginBottom = "") } var b =
                this.previousElementSibling, d = !!document.documentMode; a(); window.addEventListener("resize", function () { a() }); window.addEventListener("load", function () { a() }); return this
        }; (function (a) { var b = function (a, b, h) { var d; return function () { var c = this, g = arguments; d ? clearTimeout(d) : h && a.apply(c, g); d = setTimeout(function () { h || a.apply(c, g); d = null }, b || 100) } }; window[a] = function (d) { var c = new CustomEvent(a); return d ? this.addEventListener("resize", b(d)) : this.dispatchEvent(c) } })("smartresize"); var I = function () {
            var a = document.createElement("div"),
            b = document.querySelector("body"); a.setAttribute("style", "height: 50vh; position: absolute; top: -1000px; left: -1000px;"); b.appendChild(a); var d = parseInt(window.innerHeight / 2, 10), c = parseInt((window.getComputedStyle ? getComputedStyle(a, null) : a.currentStyle).height, 10); b.removeChild(a); return c == d
        }(); l(function () {
            function a(a) { a.style.height = 9 * q(a.parentNode) / 16 + "px" } function g(a) {
                setTimeout(function () {
                    b(a, ".mbr-parallax-background").forEach(function (a) {
                        jarallax && (jarallax(a, { speed: .6 }), a.style.position =
                            "relative")
                    })
                }, 0)
            } function d(a) {
                b(a, "[data-bg-video]").forEach(function (a) {
                    var b = a.getAttribute("data-bg-video"); if (b) {
                        ...
                        a.querySelector(".mbr-background-video-preview") || a.childNodes[0].before(c); if (d && (/youtu\.?be/g.test(d[3]) || /vimeo/g.test(d[3]))) if (d && /youtu\.?be/g.test(d[3])) {
                            b = "http" + ("https:" === location.protocol ? "s" : "") + ":"; b += "//img.youtube.com/vi/" + d[6] + "/maxresdefault.jpg"; var h = new Image; h.onload = function () {
                                if (120 === (h.naturalWidth || h.width)) {
                                    var b = h.src.split("/").pop(); switch (b) {
                                        case "maxresdefault.jpg": h.src = h.src.replace(b, "sddefault.jpg"); break; case "sddefault.jpg": h.src = h.src.replace(b, "hqdefault.jpg");
                                            break; default: m && (c.style.backgroundImage = 'url("images/no-video.jpg")', c.style.display = "block")
                                    }
                                } else c.style.backgroundImage = 'url("' + h.src + '")', c.style.display = "block"; a.querySelector(".mbr-background-video") && a.querySelector(".mbr-background-video").remove(); b = document.createElement("div"); var n = document.createElement("div"), g = document.createElement("div"), k = document.createElement("div"); k.classList.add("mbr-video-foreground"); k.appendChild(b); g.appendChild(k); n.appendChild(g); b.classList.add("mbr-background-video");
            ...
            document.querySelector("html").classList.add(w() ? "mobile" : "desktop"); window.addEventListener("scroll", function () { document.querySelectorAll(".mbr-navbar--sticky").forEach(function (a) { var b = 10 < window.scrollTop ? "add" : "remove"; a.classList[b]("mbr-navbar--stuck"); if (!a.classList.contains(".mbr-navbar--open")) a.classList[b]("mbr-navbar--short") }) }); w() && navigator.userAgent.match(/Chrome/i) ? function (a, b) {
                var d = [a, a]; d[b > a ? 0 : 1] = b; window.smartresize(function () {
                    var a = window.innerHeight; 0 > d.indexOf(a) && (a = d[window.innerWidth >
                        a ? 1 : 0]); document.querySelector(".mbr-section--full-height").style.height = a + "px"
                })
            ...
            if (u) e(document).on("add.cards changeParameter.cards", function (d) { var c = b(d.target, ".mbr-section--16by9"); c.length ? c.forEach(function (b) { b.setAttribute("data-16by9", "true"); a(b) }) : b(d.target, "[data-16by9]").forEach(function (a) { a.styles.height = ""; a.removeAttribute("data-16by9") }) }); if ("undefined" !== typeof jarallax && !w()) {
                window.addEventListener("update.parallax", function (a) {
                    setTimeout(function () {
                        if (a) {
                            var a = document.querySelector(".mbr-parallax-background"); a.jarallax("coverImage"); a.jarallax("clipContainer");
                            a.jarallax("onScroll")
                        }
                    }, 0)
                }); if (m) {
                    if (!u) return; e(document).on("add.cards", function (a) { g(a.target); e(window).trigger("update.parallax") }); e(document).on("changeParameter.cards", function (a, b, d, c) {
                        if ("bg" === b) switch (b = a.target, jarallax && jarallax(b, "destroy"), b.style.position = "", e(a.target).find(".mbr-background-video-preview").remove(), e(a.target).find(".mbr-background-video").remove(), c) {
                            case "type": !0 === d.parallax && g(a.target); break; case "value": "image" === d.type && !0 === d.parallax && g(a.target); break;
                            case "parallax": !0 === d.parallax && g(a.target)
            ...
            } var k, h, B = 0, r = null, l = !w(); window.addEventListener("scroll", function () {
                h && clearTimeout(h); var a = document.documentElement.scrollTop, b = a <= B || l; B = a; if (r) {
                    var d = a > r.breakPoint; b ? d != r.fixed && (l ? (r.fixed = d, r.elm.classList.toggle("is-fixed")) : h = setTimeout(function () { r.fixed = d; r.elm.classList.toggle("is-fixed") },
                        40)) : (r.fixed = !1, r.elm.classList.remove("is-fixed"))
                }
            }); if (u) e(document).on("add.cards delete.cards", function (a) { k && clearTimeout(k); k = setTimeout(function () { r && (r.fixed = !1, r.elm.classList.remove("is-fixed")); var a = document.querySelector(".mbr-fixed-top"); a && (r = { breakPoint: f(a).top + 3 * c(a), fixed: !1, elm: a }, a.dispatchEvent(new CustomEvent("scroll"))) }, 650) }); window.smartresize(function () {
                document.querySelectorAll(".mbr-embedded-video").forEach(function (a) {
                    a.style.height = (q(a) * parseInt(a.getAttribute("height") ||
                        315) / parseInt(a.getAttribute("width") || 560)).toFixed() + "px"
                })
            }); if (u) e(document).on("add.cards", function (a) { document.querySelector("html").classList.contains("mbr-site-loaded") && b(a.target, "iframe").length && window.dispatchEvent(new CustomEvent("resize")) }); if (m) { if (!u) return; e(document).on("add.cards", function (a) { d(a.target) }) } else d(document.body); if (m) e(document).on("changeParameter.cards", function (a, b, c, h) {
                if ("bg" === b) switch (h) {
                    case "type": "video" === c.type && d(a.target); break; case "value": "video" ===
                        c.type && d(a.target)
                }
            }); m || Array.from(document.body.children).filter(function (a) { return !a.matches("style, script") }).forEach(function (a) { a.dispatchEvent(new CustomEvent("add.cards")); u && e(a).trigger("add.cards") }); document.querySelector("html").classList.add("mbr-site-loaded"); window.dispatchEvent(new CustomEvent("resize")); window.dispatchEvent(new CustomEvent("scroll")); m || document.addEventListener("click", function (a) {
                try {
                    var b = a.target; if (!b.parents().some(function (a) { a.classList.contains("carousel") })) {
                        do if (b.hash) {
                            var d =
                                /#bottom|#top/g.test(b.hash); document.querySelector(d ? "body" : b.hash).forEach(function (d) { a.preventDefault(); var h = b.parents().some(function (a) { return a.classList.contains("navbar-fixed-top") }) ? 60 : 0; h = "#bottom" == b.hash ? c(d) - window.innerHeight : f(d).top - h; d.classList.contains("panel-collapse") || d.classList.contains("tab-pane") || window.scrollTo({ top: h, left: 0, behavior: "smooth" }) }); break
                ...
                function b() {
                    d.style.width =
                    ""; d.style.maxWidth = ""; d.style.marginLeft = ""; if (k && g) { var b = k / g; a.style.position = "absolute"; a.style.top = "0"; a.style.left = "0"; a.style.right = "0"; a.style.bottom = "0"; var e = c(h) / q(h); e > b && (b = 100 * (e - b) / b, d.style.width = b + 100 + "%", d.style.maxWidth = b + 100 + "%", d.style.marginLeft = -b / 2 + "%") }
                } var d = a.querySelector("img"), h = a.parentNode, g = d.width, k = d.height; d.addEventListener("load", function () { g = d.width; k = d.height; b() }, { once: !0 }); window.addEventListener("resize", b); b()
            })
        }); if (!m) {
                    ...
                    if (!w() && document.querySelectorAll("input[name=animation]").length) {
                        var a = function () {
                            ...
                            if (a.parents(".carousel-item").some(function (a) {
                                ...
                                var d = b.getAttribute("data-visible"); if (a.parents().some(function (a) { return a.matches(".cloneditem-" + (d - 1)) }) && a.parents(".cloneditem-" + (d - 1)).some(function (a) { return a.getAttribute("data-cloned-index") >= d })) return !0; a.classList.remove("animate__animated animate__delay-1s hidden");
                                return !1
                            } return !0
        ...
        } l(function () { if (document.querySelectorAll(".mbr-arrow-up").length) { var a = document.querySelector("#scrollToTop"); a.style.display = "none"; window.addEventListener("scroll", function () { window.scrollY > window.innerHeight ? t(a) : p(a) }); a.addEventListener("click", function () { window.scrollTo({ top: 0, left: 0, behavior: "smooth" }); return !1 }) } }); if (!m) {
            var v = document.querySelector(".mbr-arrow"); v &&
                v.addEventListener("click", function (a) { a = a.target.closest("section").nextElementSibling; a.classList.contains("engine") && (a = a.closest("section").nextElementSibling); window.scrollTo(0, f(a).top) })
            ...
            function (a) {
                var b = a.target; b.classList.contains("mbr-fullscreen") && (a = function () { b.style.height = "auto"; b.offsetHeight <= window.innerHeight && (b.style.height = "1px") }, window.addEventListener("load", a), window.addEventListener("resize", a)); if (b.classList.contains("mbr-slider") || b.classList.contains("mbr-gallery")) b.querySelectorAll(".carousel-indicators").forEach(function (a) { a.classList.add("ie-fix"); a.querySelectorAll("li").forEach(function (a) { a.style.display = "inline-block"; a.style.width = "30px" }) }), b.classList.contains("mbr-slider") &&
                    b.querySelectorAll(".full-screen .slider-fullscreen-image").forEach(function (a) { a.style.height = "1px" })
            }); l(function () {
                if (!m) {
                    var a = function (a) { b(a.target) }, b = function (b) {
                        var d = b.parents("section")[0].querySelector("iframe"), c = d.getAttribute("src"); b.parents("section").forEach(function (a) { a.style.zIndex = "5000" }); -1 !== c.indexOf("youtu") && d.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*"); if (-1 !== c.indexOf("vimeo")) { var g = new Vimeo.Player(d); g.play() } var e = b.parents("section")[0],
                            f = e.querySelector(e.querySelector("[data-modal]").getAttribute("data-modal")); f.style.display = "table"; f.addEventListener("click", function () { -1 !== c.indexOf("youtu") && d.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"); -1 !== c.indexOf("vimeo") && g.pause(); f.style.display = "none"; f.removeEventListener("click", a); e.style.zIndex = "0" })
                    }; document.querySelectorAll(".modalWindow-video > iframe").forEach(function (a) {
                        var b = a.getAttribute("data-src"); a.removeAttribute("data-src");
                        var d = b.match(/(http:\/\/|https:\/\/|)?(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(&\S+)?/); -1 !== b.indexOf("youtu") ? a.setAttribute("src", "https://youtube.com/embed/" + d[6] + "?rel=0&enablejsapi=1") : -1 !== b.indexOf("vimeo") && a.setAttribute("src", "https://player.vimeo.com/video/" + d[6] + "?autoplay=0&loop=0")
                ...
                var z = document.querySelectorAll(".dropdown-menu.show"); v.forEach(function (a) { a.classList.remove("show"); a.ariaExpanded = "false" }); z.forEach(function (a) { return a.classList.remove("show") }); !w() && (v = document.querySelector("section.menu")) && (z = window.innerWidth, !v.querySelector(".navbar").classList.contains("collapsed") && 991 < z && (v.querySelectorAll("ul.navbar-nav li.dropdown").forEach(function (a) {
                    a.addEventListener("mouseover", function () { a.classList.contains("open") && a.querySelector("a").dispatchEvent(new CustomEvent("click")) });
                    a.addEventListener("mouseout", function () { a.classList.contains("open") && a.querySelector("a").dispatchEvent(new CustomEvent("click")) })
                }), v.querySelectorAll("ul.navbar-nav li.dropdown .dropdown-menu .dropdown").forEach(function (a) { a.addEventListener("mouseover", function () { a.classList.contains("open") && a.querySelector("a").dispatchEvent(new CustomEvent("click")) }); a.addEventListener("mouseout", function () { a.classList.contains("open") && a.querySelector("a").dispatchEvent(new CustomEvent("click")) }) })))
            } m ||
                ("undefined" === typeof window.initClientPlugin && 0 != document.body.querySelectorAll(".clients").length && (window.initClientPlugin = !0, document.body.querySelectorAll(".clients").forEach(function (a) { a.getAttribute("data-isinit") || (A(a), F(a)) })), "undefined" === typeof window.initPopupBtnPlugin && 0 != document.body.querySelectorAll("section.popup-btn-cards").length && (window.initPopupBtnPlugin = !0, document.querySelectorAll("section.popup-btn-cards .card-wrapper").forEach(function (a) { a.classList.add("popup-btn") })),
                    "undefined" === typeof window.initTestimonialsPlugin && 0 != document.body.querySelectorAll(".testimonials-slider").length && (window.initTestimonialsPlugin = !0, document.querySelectorAll(".testimonials-slider").forEach(function (a) { A(a) })), "undefined" === typeof window.initSwitchArrowPlugin && (window.initSwitchArrowPlugin = !0, l(function () {
                        ...
                        a.addEventListener("click", function () {
                            var b = a.closest(".accordionStyles").getAttribute("id"), d = a.closest(".card").querySelector(".panel-collapse"), c = a.querySelector("span.sign") ? a.querySelector("span.sign") : a.querySelector("span.mbr-iconfont"); !d.classList.contains("collapsing") || -1 == b.indexOf("toggle") && -1 == b.indexOf("accordion") || (a.classList.contains("collapsed") ?
                    ...
                    document.querySelectorAll(".mbr-slider.carousel").forEach(function (a) {
                        var b = a.querySelectorAll(".carousel-control"), d = a.querySelectorAll(".carousel-indicators li"), c = function (a) { a.stopPropagation(); a.preventDefault() }; a.addEventListener("slide.bs.carousel", function () { b.forEach(function (a) { a.addEventListener("click", c) }); d.forEach(function (a) { a.addEventListener("click", c) }); u && e(a).carousel({ keyboard: !1 }) }); a.addEventListener("slid.bs.carousel", function () {
                            b.forEach(function (a) {
                                a.removeEventListener("click",
                                    c)
                            }); d.forEach(function (a) { a.removeEventListener("click", c) }); u && e(a).carousel({ keyboard: !0 }); 1 < a.querySelectorAll(".carousel-item.active").length && (a.querySelectorAll(".carousel-item.active")[1].classList.remove("active"), a.querySelectorAll(".carousel-control li.active")[1].classList.remove("active"))
                        })
                    })); if (m) {
                        if (!u) return; e(document).on("add.cards", function (a) {
                            e(a.target).find(".form-with-styler").length && (a = e(a.target).find(".form-with-styler"), e(a).find('select:not("[multiple]")').each(function () {
                                e(this).styler &&
                                e(this).styler()
                            }), e(a).find("input[type=number]").each(function () { e(this).styler && (e(this).styler(), e(this).parent().parent().removeClass("form-control")) }), e(a).find("input[type=date]").each(function () { e(this).datetimepicker && e(this).datetimepicker({ format: "Y-m-d", timepicker: !1 }) }), e(a).find("input[type=time]").each(function () { e(this).datetimepicker && e(this).datetimepicker({ format: "H:i", datepicker: !1 }) }))
                        })
